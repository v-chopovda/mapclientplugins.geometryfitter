...
#
# Created: Mon Dec 21 16:29:05 2020
...
class Ui_GeometricFitWidget(object):
    def setupUi(self, GeometricFitWidget):
        ...
        self.stepedit_scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -387, 671, 1030))
        ...
        self.formLayout_2.setWidget(4, QtGui.QFormLayout.LabelRole, self.alignRotation_label)
        ...
        self.formLayout_2.setWidget(4, QtGui.QFormLayout.FieldRole, self.alignRotation_lineEdit)
        self.alignScale_label = QtGui.QLabel(self.align_groupBox)
        self.alignScale_label.setObjectName("alignScale_label")
        self.formLayout_2.setWidget(5, QtGui.QFormLayout.LabelRole, self.alignScale_label)
        ...
        self.formLayout_2.setWidget(5, QtGui.QFormLayout.FieldRole, self.alignScale_lineEdit)
        ...
        self.formLayout_2.setWidget(6, QtGui.QFormLayout.LabelRole, self.alignTranslation_label)
        ...
        self.formLayout_2.setWidget(6, QtGui.QFormLayout.FieldRole, self.alignTranslation_lineEdit)
        self.alignGroups_checkBox = QtGui.QCheckBox(self.align_groupBox)
        self.alignGroups_checkBox.setObjectName("alignGroups_checkBox")
        self.formLayout_2.setWidget(1, QtGui.QFormLayout.LabelRole, self.alignGroups_checkBox)
        ...
        self.formLayout_2.setWidget(1, QtGui.QFormLayout.FieldRole, self.alignMarkers_checkBox)
        ...
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.LabelRole, self.fitMarkerWeight_label)
        ...
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.FieldRole, self.fitMarkerWeight_lineEdit)
        ...
        self.formLayout_3.setWidget(3, QtGui.QFormLayout.LabelRole, self.fitStrainPenalty_label)
        ...
        self.formLayout_3.setWidget(3, QtGui.QFormLayout.FieldRole, self.fitStrainPenalty_lineEdit)
        ...
        self.formLayout_3.setWidget(4, QtGui.QFormLayout.LabelRole, self.fitCurvaturePenalty_label)
        ...
        self.formLayout_3.setWidget(4, QtGui.QFormLayout.FieldRole, self.fitCurvaturePenalty_lineEdit)
        ...
        self.formLayout_3.setWidget(5, QtGui.QFormLayout.LabelRole, self.fitEdgeDiscontinuityPenalty_label)
        ...
        self.formLayout_3.setWidget(5, QtGui.QFormLayout.FieldRole, self.fitEdgeDiscontinuityPenalty_lineEdit)
        self.fitIterations_label = QtGui.QLabel(self.fit_groupBox)
        self.fitIterations_label.setObjectName("fitIterations_label")
        self.formLayout_3.setWidget(7, QtGui.QFormLayout.LabelRole, self.fitIterations_label)
        ...
        self.formLayout_3.setWidget(7, QtGui.QFormLayout.FieldRole, self.fitIterations_spinBox)
        self.fitMaximumSubIterations_label = QtGui.QLabel(self.fit_groupBox)
        self.fitMaximumSubIterations_label.setObjectName("fitMaximumSubIterations_label")
        self.formLayout_3.setWidget(8, QtGui.QFormLayout.LabelRole, self.fitMaximumSubIterations_label)
        self.fitMaximumSubIterations_spinBox = QtGui.QSpinBox(self.fit_groupBox)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.fitMaximumSubIterations_spinBox.sizePolicy().hasHeightForWidth())
        self.fitMaximumSubIterations_spinBox.setSizePolicy(sizePolicy)
        self.fitMaximumSubIterations_spinBox.setMinimum(1)
        self.fitMaximumSubIterations_spinBox.setMaximum(1000)
        self.fitMaximumSubIterations_spinBox.setObjectName("fitMaximumSubIterations_spinBox")
        self.formLayout_3.setWidget(8, QtGui.QFormLayout.FieldRole, self.fitMaximumSubIterations_spinBox)
        ...
        self.formLayout_3.setWidget(9, QtGui.QFormLayout.LabelRole, self.fitUpdateReferenceState_checkBox)
        self.fitLineWeight_label = QtGui.QLabel(self.fit_groupBox)
        self.fitLineWeight_label.setObjectName("fitLineWeight_label")
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.LabelRole, self.fitLineWeight_label)
        self.fitLineWeight_lineEdit = QtGui.QLineEdit(self.fit_groupBox)
        self.fitLineWeight_lineEdit.setObjectName("fitLineWeight_lineEdit")
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.FieldRole, self.fitLineWeight_lineEdit)
    ...
    def retranslateUi(self, GeometricFitWidget):
        ...
        self.alignGroups_checkBox.setText(QtGui.QApplication.translate("GeometricFitWidget", "Align groups", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.fitMarkerWeight_lineEdit.setToolTip(QtGui.QApplication.translate("GeometricFitWidget", "<html><head/><body><p>Weighting of marker points with fixed mesh locations. Use 0.0 to omit.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.fitMaximumSubIterations_label.setText(QtGui.QApplication.translate("GeometricFitWidget", "Maximum subiterations:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.fitLineWeight_label.setText(QtGui.QApplication.translate("GeometricFitWidget", "Line weight:", None, QtGui.QApplication.UnicodeUTF8))
        self.fitLineWeight_lineEdit.setToolTip(QtGui.QApplication.translate("GeometricFitWidget", "<html><head/><body><p>Weighting of data points which project onto line features.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))

...
class Ui_GeometricFitWidget(object):
    def setupUi(self, GeometricFitWidget):
        ...
        GeometricFitWidget.resize(1718, 1653)
        ...
        self.formLayout_2.setWidget(1, QtGui.QFormLayout.LabelRole, self.alignRotation_label)
        ...
        self.formLayout_2.setWidget(1, QtGui.QFormLayout.FieldRole, self.alignRotation_lineEdit)
        self.alignScale_label = QtGui.QLabel(self.align_groupBox)
        self.alignScale_label.setObjectName("alignScale_label")
        self.formLayout_2.setWidget(2, QtGui.QFormLayout.LabelRole, self.alignScale_label)
        self.alignScale_lineEdit = QtGui.QLineEdit(self.align_groupBox)
        self.alignScale_lineEdit.setObjectName("alignScale_lineEdit")
        self.formLayout_2.setWidget(2, QtGui.QFormLayout.FieldRole, self.alignScale_lineEdit)
        ...
        self.formLayout_2.setWidget(3, QtGui.QFormLayout.LabelRole, self.alignTranslation_label)
        ...
        self.formLayout_2.setWidget(3, QtGui.QFormLayout.FieldRole, self.alignTranslation_lineEdit)
        ...
        self.formLayout_2.setWidget(0, QtGui.QFormLayout.LabelRole, self.alignMarkers_checkBox)
        ...
        self.formLayout_3.setWidget(0, QtGui.QFormLayout.LabelRole, self.fitStrainPenalty_label)
        ...
        self.formLayout_3.setWidget(0, QtGui.QFormLayout.FieldRole, self.fitStrainPenalty_lineEdit)
        ...
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.LabelRole, self.fitCurvaturePenalty_label)
        ...
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.FieldRole, self.fitCurvaturePenalty_lineEdit)
        ...
        self.formLayout_3.setWidget(4, QtGui.QFormLayout.LabelRole, self.fitUpdateReferenceState_checkBox)
        self.fitIterations_label = QtGui.QLabel(self.fit_groupBox)
        self.fitIterations_label.setObjectName("fitIterations_label")
        self.formLayout_3.setWidget(3, QtGui.QFormLayout.LabelRole, self.fitIterations_label)
        ...
        self.formLayout_3.setWidget(3, QtGui.QFormLayout.FieldRole, self.fitIterations_spinBox)
        ...
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.LabelRole, self.fitEdgeDiscontinuityPenalty_label)
        ...
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.FieldRole, self.fitEdgeDiscontinuityPenalty_lineEdit)
        self.verticalLayout.addWidget(self.fit_groupBox)
        ...
        self.displayMarkerProjections_checkBox = QtGui.QCheckBox(self.displayMarker_frame)
        self.displayMarkerProjections_checkBox.setObjectName("displayMarkerProjections_checkBox")
        self.gridLayout.addWidget(self.displayMarkerProjections_checkBox, 0, 2, 1, 1)
        self.displayMarkerModelPoints_checkBox = QtGui.QCheckBox(self.displayMarker_frame)
        self.displayMarkerModelPoints_checkBox.setObjectName("displayMarkerModelPoints_checkBox")
        self.gridLayout.addWidget(self.displayMarkerModelPoints_checkBox, 3, 0, 1, 1)
        self.displayMarkerModelNames_checkBox = QtGui.QCheckBox(self.displayMarker_frame)
        self.displayMarkerModelNames_checkBox.setObjectName("displayMarkerModelNames_checkBox")
        self.gridLayout.addWidget(self.displayMarkerModelNames_checkBox, 3, 1, 1, 1)
        ...
        self.displayDataModelPoints_checkBox = QtGui.QCheckBox(self.displayData_frame)
        self.displayDataModelPoints_checkBox.setObjectName("displayDataModelPoints_checkBox")
        self.horizontalLayout_9.addWidget(self.displayDataModelPoints_checkBox)
    ...
    def retranslateUi(self, GeometricFitWidget):
        ...
        self.displayMarkerProjections_checkBox.setText(QtGui.QApplication.translate("GeometricFitWidget", "Marker projections", None, QtGui.QApplication.UnicodeUTF8))
        self.displayMarkerModelPoints_checkBox.setText(QtGui.QApplication.translate("GeometricFitWidget", "Marker model points", None, QtGui.QApplication.UnicodeUTF8))
        self.displayMarkerModelNames_checkBox.setText(QtGui.QApplication.translate("GeometricFitWidget", "Marker model names", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.displayDataModelPoints_checkBox.setText(QtGui.QApplication.translate("GeometricFitWidget", "Data model points", None, QtGui.QApplication.UnicodeUTF8))
